...
public class BezierCurve : MonoBehaviour
{
    ...
    void RenderBezierCurve(){
        ...
        List<Vector3> mesh_normal=new List<Vector3>();
        ...
        for(int i =0;i<mesh_segment;i++){
            ...
            mesh_normal.Add(new Vector3(0,0,1f));
        ...
        bezierCurveMesh.normals=mesh_normal.ToArray();
        bezierCurveMesh.RecalculateNormals();
